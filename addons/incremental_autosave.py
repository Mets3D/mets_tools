...
class IncrementalAutoSavePreferences(bpy.types.AddonPreferences):
    ...
    autosave_path_linux: StringProperty(
        name='Autosave Path (Linux)',
        description='Path to auto save files into',
        subtype='FILE_PATH',
        default='',
    )
    autosave_path_windows: StringProperty(
        name='Autosave Path (Windows)',
        description='Path to auto save files into',
        subtype='FILE_PATH',
        default='',
    )
    autosave_path_mac: StringProperty(
        name='Autosave Path (Mac)',
        description='Path to auto save files into',
        subtype='FILE_PATH',
        default='',
    )
    ...
    def draw(self, context):
        ...
        layout.prop(
            ...
            text="Enable Native Autosave (Redundant)",
        )
        ...
        # This is due to a bug with linked lib paths on Recover:
        # https://projects.blender.org/blender/blender/issues/112423
        layout.label(
            text='Note: Use "File->Open" rather than "Recover->Autosave" when opening files.',
            icon='ERROR',
        )
